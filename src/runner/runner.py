...
from src.agent_session.session import session_service
...
async def main():
    ...
    await call_agent_and_print(rootAgentRunner, root_agent, SESSION_ID, '{"country": "France"}')
